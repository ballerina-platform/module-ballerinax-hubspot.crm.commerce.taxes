...
public isolated client class Client {
    ...
    # + return - No content 
    resource isolated function delete [string taxId](map<string|string[]> headers = {}) returns http:Response|error {
    ...
    resource isolated function get .(map<string|string[]> headers = {}, *GetCrmV3ObjectsTaxes_getpageQueries queries) returns CollectionResponseSimplePublicObjectWithAssociationsForwardPaging|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - successful operation 
    resource isolated function get [string taxId](map<string|string[]> headers = {}, *GetCrmV3ObjectsTaxesTaxid_getbyidQueries queries) returns SimplePublicObjectWithAssociations|error {
        string resourcePath = string `/${getEncodedUri(taxId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["private-app"] = self.apiKeyConfig?.private\-app;
    ...
    # + queries - Queries to be sent with the request 
    # + return - successful operation 
    resource isolated function patch [string taxId](SimplePublicObjectInput payload, map<string|string[]> headers = {}, *PatchCrmV3ObjectsTaxesTaxid_updateQueries queries) returns SimplePublicObject|error {
        string resourcePath = string `/${getEncodedUri(taxId)}`;
        map<anydata> headerValues = {...headers};
        if self.apiKeyConfig is ApiKeysConfig {
            headerValues["private-app"] = self.apiKeyConfig?.private\-app;
    ...
    # + queries - Queries to be sent with the request 
    # + return - successful operation 
    resource isolated function post batch/read(BatchReadInputSimplePublicObjectId payload, map<string|string[]> headers = {}, *PostCrmV3ObjectsTaxesBatchRead_readQueries queries) returns BatchResponseSimplePublicObject|BatchResponseSimplePublicObjectWithErrors|error {
