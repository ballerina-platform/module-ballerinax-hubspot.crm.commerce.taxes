...
public type GetCrmV3ObjectsTaxes_getpageQueries record {
...
public type PostCrmV3ObjectsTaxesBatchRead_readQueries record {
    # Whether to return only results that have been archived.
    boolean archived = false;
};
...
public type PatchCrmV3ObjectsTaxesTaxid_updateQueries record {
    # The name of a property whose values are unique for this object type
    string idProperty?;
};

# Represents the Queries record for the operation: get-/crm/v3/objects/taxes/{taxId}_getById
public type GetCrmV3ObjectsTaxesTaxid_getbyidQueries record {
    # A comma separated list of object types to retrieve associated IDs for. If any of the specified associations do not exist, they will be ignored.
    string[] associations?;
    # Whether to return only results that have been archived.
    boolean archived = false;
